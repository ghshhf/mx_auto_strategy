...
COIN_ALIASES: dict[str, str] = {
    ...
    "币安币": "BNB", "bnb": "BNB",
    "瑞波币": "XRP", "xrp": "XRP",
    "卡尔达诺": "ADA", "ada": "ADA", "Cardano": "ADA", "cardano": "ADA",
    "狗狗币": "DOGE", "doge": "DOGE", "Dogecoin": "DOGE", "dogecoin": "DOGE",
    "dot": "DOT", "波卡": "DOT", "Polkadot": "DOT",
    "matic": "POL", "polygon": "POL",
    "arb": "ARB", "Arbitrum": "ARB", "arbitrum": "ARB",
    "uni": "UNI", "Uniswap": "UNI",
    "ltc": "LTC", "莱特币": "LTC", "Litecoin": "LTC", "litecoin": "LTC",
    "link": "LINK", "Chainlink": "LINK",
    "avax": "AVAX", "雪崩": "AVAX", "Avalanche": "AVAX", "avalanche": "AVAX",
    "aave": "AAVE", "Aave": "AAVE",
    "xlm": "XLM", "恒星币": "XLM", "Stellar": "XLM", "stellar": "XLM",
    "trx": "TRX", "波场": "TRX", "Tron": "TRX", "tron": "TRX",
    "ton": "GRAM", "toncoin": "GRAM", "ton blockchain": "GRAM",
    "the open network": "GRAM", "telegram open network": "GRAM",
    "toncoin (ton)": "GRAM", "gram (ton)": "GRAM",
    "bch": "BCH", "比特现金": "BCH", "bitcoin cash": "BCH",
    "zec": "ZEC", "大零币": "ZEC", "zcash": "ZEC", "Zcash": "ZEC",
    ...
    "okb": "OKB",
    "dydx": "DYDX", "dYdX": "DYDX",
    "hype": "HYPE", "Hyperliquid": "HYPE", "hyperliquid": "HYPE",
    "tao": "TAO", "Bittensor": "TAO",
    "glm": "GLM", "Golem": "GLM",
    "render": "RENDER", "RNDR": "RENDER",
    "ondo": "ONDO", "ondo finance": "ONDO", "Ondo Finance": "ONDO",
