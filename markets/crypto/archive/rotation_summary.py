...
# 跨市场数据已于 2026-09-01 归位到各自市场目录; 加密面板仍在 markets/crypto/data。
_HERE = os.path.dirname(os.path.abspath(__file__))     # markets/crypto/archive
_CRYPTO = os.path.dirname(_HERE)                        # markets/crypto
_ROOT = os.path.dirname(os.path.dirname(_CRYPTO))        # 仓库根
CSV_DIRS = {
    "加密": os.path.join(_CRYPTO, "data"),
    "A股": os.path.join(_ROOT, "markets", "ashare", "data"),
    "美股": os.path.join(_ROOT, "markets", "us", "data"),
}
