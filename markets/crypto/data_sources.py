...
设计原则:
  ...
  - 加法存在: 不删除/替换 sync_crypto_panel.py 与 crypto_hist_data.py; 旧 28,092x
    管线为期权时代口径, 已废弃, 现真值为 27 币现货+周期(发布 NAV 5,614.96x / reconcile 10y FULL 6,043x). 本模块是它们的"干净继任者", 迁移时再删旧代码。
...
CMC_IDS = {
    ...
    'DOT': 6636, 'ETH': 1027, 'GLM': 1455, 'FIL': 2280, 'LINK': 1975, 'LTC': 2,
    'CFG': 4160, 'POL': 6690, 'OKB': 3897, 'XRP': 52,
    'RENDER': 5690, 'SOL': 5426,
    'GRAM': 11419, 'TRX': 1958, 'UNI': 7083, 'ZEC': 1437,
    'ETHFI': 29814, 'PENDLE': 9481, }
