...
- **头条 5,662.51x** · CAGR 135.7% · MDD −70.4% · Sharpe 1.60（**32 币池** · 现货轮动 + 减半相位叠加 = 发布 NAV）
  - 🔄 **2026-09-06 池变更重跑**：删 ICP（无硬顶供应，Mission 70 前通胀 9.72%）+ INJ（软顶 1 亿但动态增发 5%–10%，机制过复杂）→ 34 币池降为 32 币。原 34 币头条 **7,637.77x / −69.6% / Sharpe 1.64 已作废**，不可再引用
- 口径变体（**32 币池，2026-09-06 重跑**）：reconcile 10y FULL（inv_vol + 1.2x + 周期）**6,030x** / −70.5% / Sharpe 1.60 / CAGR 137.2%；12y FULL **18,622x** / −70.5% / Sharpe 1.56；10y 关周期 2,407x / −79.4%；10y 纯现货轮动（关周期 + 1.0x）581x / −76.1%
  - ⚠️ 旧 34 币变体（21,419x / 8,488x / 26,211x）**已作废**，勿再引用
- 数据：`weekly_adjclose_crypto50_10y.csv` 为唯一真值基准（**32 币**，末日 2026-08-28，Binance/OKX/Gate）；c50/v3 已对齐、三面板零偏差零空洞
